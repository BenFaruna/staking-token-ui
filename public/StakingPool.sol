...
contract StakingPool {
    ...
    function getPoolByID(uint256 _id)
        external
        view
        returns (PoolDataReturnedType memory _pool)
    {
    ...
    function _getUserReward(uint256 _poolID, address _account)
        internal
        view
        returns (uint256 _userReward)
    {
    ...
    function getUserClaimableReward(uint256 _poolID, address _staker)
        external
        view
    ...
    function getUserStakeBalance(uint256 _poolID, address _account)
        external
        view
